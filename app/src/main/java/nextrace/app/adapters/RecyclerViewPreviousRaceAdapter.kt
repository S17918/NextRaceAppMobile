...
class RecyclerViewPreviousRaceAdapter(val raceList: List<Race>, val clickListener: ClickListener): RecyclerView.Adapter<RecyclerViewPreviousRaceAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_race_small_left, parent, false))
    }
