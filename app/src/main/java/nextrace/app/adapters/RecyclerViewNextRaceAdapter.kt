...
class RecyclerViewNextRaceAdapter(val raceList: List<Race>, val clickListener: ClickListener): RecyclerView.Adapter<RecyclerViewNextRaceAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_race_small_right, parent, false))
    }
